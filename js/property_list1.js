window.addEventListener("load", function () {
    var is_interested_images = document.getElementsByClassName("is_interested_image");
...
var toggle_interested_success = function (event) {
    ...
    if (response.success) {
        ...
        var interested_user_count = document.querySelectorAll(".property-id-" + property_id + " .interested_user_count")[0];
